...
function theme_url($url) {
  return create_url(CGlantz::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CGlantz::Instance()->themeParentUrl . "/{$url}");
}


function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CGlantz::Instance()->request->CreateUrl($urlOrController, $method, $arguments);
}
